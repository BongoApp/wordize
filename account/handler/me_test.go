...
import (
	...
	"github.com/BongoApp/wordize/account/model/apperrors"
	"github.com/BongoApp/wordize/account/model/mocks"
...
func TestMe(t *testing.T){
	...
	//	mockUserRep:=&model.User{
	//		UID: uid,
	//		Email: "cosme.fulanito@acme.com",
	//		Name: "Cosme Fulanito",
	//	}
	//	mockUserService:= new(mocks.MockUserService)
	//	mockUserService.On("GET",mock.AnythingOfType("*gin.Context"),uid).Return(mockUserRep,nil)
	//
